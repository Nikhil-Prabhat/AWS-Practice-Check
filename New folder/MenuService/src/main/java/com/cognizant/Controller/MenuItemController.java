...
public class MenuItemController {
	...
	@GetMapping("viewall")
	public ResponseEntity<?> getAll(@RequestHeader(name="auth")String token) {
	...
	@GetMapping("{id}")
	public ResponseEntity<?> getById(@RequestHeader(name="auth")String token,@PathVariable("id") int id) {
